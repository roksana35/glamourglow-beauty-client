...
const Footer = () => {
    ...
    <div className="container flex flex-col items-center justify-between p-3 mx-auto space-y-4 sm:space-y-0 sm:flex-row">
        <a href="#">
            ...
            <p className="flex justify-center items-center font-lato font-bold">
            <img className="w-full h-[90px]" src="https://i.ibb.co/XWyxF9h/12343867-4962315.jpg" alt=""></img>
                <span>GlamourGlow <br /> Beauty</span></p>
        </a>
